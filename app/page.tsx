      ...
      <div className="relative container mx-auto px-4 py-16">
        <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <p className="text-xl text-gray-700 mb-8 max-w-3xl mx-auto leading-relaxed">
            Create engaging quizzes with <span className="font-semibold text-indigo-600">AI-powered question generation</span> and share them with participants worldwide
          </p>
        ...
        <div className={`grid md:grid-cols-3 gap-8 max-w-5xl mx-auto transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="group card text-center transform transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:-translate-y-2 cursor-pointer">
            <div className="relative">
              ...
              <div className="absolute inset-0 bg-green-100 rounded-full w-20 h-20 mx-auto -z-10 group-hover:scale-110 transition-transform duration-300"></div>
            </div>
          ...
          <div className="group card text-center transform transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:-translate-y-2 cursor-pointer">
            <div className="relative">
              ...
              <div className="absolute inset-0 bg-yellow-100 rounded-full w-20 h-20 mx-auto -z-10 group-hover:scale-110 transition-transform duration-300"></div>
            </div>
